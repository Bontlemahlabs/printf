 ...
 */
int write_number(int is_negative,
		int ind, char buffer[], int flags,
		...
		int length, char padd, char extra_c)
{
	...
	if (prec == 0 && ind == BUFF_SIZE –
			2 && buffer[ind] == '0' && width == 0)
		return (0); 
	if (prec == 0 && ind == BUFF_SIZE –
			2 && buffer[ind] == '0')
	{
